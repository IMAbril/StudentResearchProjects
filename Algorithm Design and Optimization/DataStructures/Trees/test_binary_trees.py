"""Unit testing file for BST_exercises.py"""

import Trees.BST_exercises as BST_exercises
import pytest


@pytest.fixture # pytest fixture to help in the construction of a tree
def build_the_tree():
    tree_1 = BST_exercises.BST()
...
def test_dll_insert():
    ...
    list1 = BST_exercises.DoublyLinkedList()
