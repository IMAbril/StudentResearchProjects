...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXPY_Intro" "ConvolutionFiltering" "Dijkstra" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "InteriorPoint_Quadratic" "MarkovChains" "NMF" "NearestNeighbor" "PolynomialInterpolation" "Simplex" "Wavelets")
